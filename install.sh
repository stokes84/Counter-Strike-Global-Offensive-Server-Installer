...
mp_ct_default_grenades "weapon_incgrenade weapon_flashbang weapon_smokegreande weapon_hegrenade"
mp_ct_default_secondary	"weapon_p250"
mp_ct_default_primary "weapon_m4a1s"
mp_t_default_melee "weapon_knife_butterfly"
mp_ct_default_grenades "weapon_molotov weapon_flashbang weapon_smokegreande weapon_hegrenade"
